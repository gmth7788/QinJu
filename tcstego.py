...
if __name__ == "__main__":
    try:
        ...
        print
        print
        "<INPUT> is a file in one of the following formats:"
        fmtlist = []
        for fmt in FORMATS:
        ...
        for name, exts in fmtlist:
            print
            "    %s  (%s)" % (name.ljust(maxlen), ", ".join(["*." + ext for ext in exts]))
        print
        print
        "<OUTPUT> is a TrueCrypt container containing a hidden volume. The file will be"
        print
